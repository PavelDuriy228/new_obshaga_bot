from config import wks2 as wks
...
async def reader_old_table ():
    ...
    for sheet in sheet_names:                
        ...
        # стандартизация с новыми названиями
        if len(name_sheet)>5: name_sheet = f"{name_sheet[:-5]} {name_sheet[5:]}"
    ...
    mess= "Обновление БД  из старой книги- было завершено"
